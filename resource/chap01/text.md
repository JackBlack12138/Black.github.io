...
现代IDE或者编译器提供的默认配置、编译和链接参数虽然能简化我们日常的程序开发，但在这样的开发中，我们常常会被这些集成工具提供的强大功能所迷惑。程序很多莫名奇妙的错误无所适从，对程序运行时的性能瓶颈也束手无策。集成工具对程序运行背后的机制和机理的掩盖是我们无法看清这些问题的本质，而只有深入理解程序执行背后的每一个步骤，我们才能更游刃有余地应对开发中可能遇到的各种问题。
